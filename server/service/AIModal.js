    ...
    history: [
        {
            ...
            parts: [
                {
                    text: "if i send that data to you and i want you to make a recomended 15 -20 exercise for user want to lose weight, with injurie in leg, and gimme the duration in second.",
                },
            ],
        },
        {
