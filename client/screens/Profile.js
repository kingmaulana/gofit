...
import {
  View, Text, StyleSheet, TouchableOpacity, SafeAreaView, ScrollView, Image, ActivityIndicator
} from 'react-native';
        ...
        >
          <View style={styles.profileHeader}>
            <View style={styles.avatarContainer}>
              <Image
                source={{uri: `https://image.pollinations.ai/prompt/social%20profile%20picture%20for%20person%20with%20name%20${user.name ? user.name : user.username}`}}
                style={styles.avatar}
          ...
          <View style={styles.profileInfo}>
            <Text style={styles.nameText}>{user.name ? user.name : user.username}</Text>
